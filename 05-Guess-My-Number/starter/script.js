...
const numMessage = function(number){
...
document.querySelector(`.highscore`).textContent = highScore;
   ...
   message(`your number is high, wrong answer`);
    score -= 1;    
    document.querySelector(`.score`).textContent = score;
    life;
  }//when the number is low
  else {
    message(`your number is low, wrong answer`);
    score -= 1;
    document.querySelector(`.score`).textContent = score;
    life;
